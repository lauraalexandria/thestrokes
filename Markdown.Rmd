...
Acho que é bom eu tirar esses boxplots por jitters, por exemplo o Ep com 3 músicas fica bem difícil de comparar.
...
jitter_por_album <- function(var){
  ...
  songs %>% 
    ...
    e_charts(album_name) %>%  
    e_scatter(choosen_var, symbol_size = 5) %>%
    e_scatter(choosen_var, jitter_factor = 2, symbol_size = 6) %>% 
    e_color("#AC3D3D") %>% 
    e_tooltip(backgroundColor = "rgb(255,255,255,0.8)", 
              borderColor = '#333', borderWidth = 1,
              textStyle = list(color = '#333')) %>% 
