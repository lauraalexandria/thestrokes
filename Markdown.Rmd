...
prop_sent_by_song <- function(input_album){
  ...
  e_tooltip("item", 
            ...
            borderColor = '#333', borderWidth = 1,
            textStyle = list(color = '#333')) %>% 
    e_text_g(principal_sentimento) # algum erro aqui
...
gauge_trios <- function(sent){
  ...
  e_gauge(as.numeric((top_3[1,4]*100) %>% round(1)), 
          paste0("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", top_3[1,1]),
          z = 1)

  g2 <- e_charts() %>% 
  e_gauge(as.numeric((top_3[2,4]*100) %>% round(1)), 
          paste0("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", top_3[2,1])) 

  g3 <- e_charts() %>% 
  e_gauge(as.numeric((top_3[3,4]*100) %>% round(1)), 
          paste0("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", top_3[3,1])) 
...
Cossine similarity (tryed to keep the 10 more common words in each song) e testar no lugar da freq, o td-idft
