...
albuns <- data.frame(SName = c("Is This It", "Modern Age", "Alone, Together", 
                               "Barely Legal", "Someday", "Last Night", "Hard to Explain",
                               "When It Started", "Trying Your Luck", "Take It Or Leave It",
                               "What Ever Happened?", "Reptilia", "Automatic Stop", 
                               "12:51", "You Talk Way Too Much", "Between Love & Hate",
